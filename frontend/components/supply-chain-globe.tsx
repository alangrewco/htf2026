...
const MARKERS = [
    ...
    { lat: 25.27, lng: 55.3, label: "Dubai" },
...
const CONNECTIONS: { from: [number, number]; to: [number, number] }[] = [
    { from: [33.74, -118.28], to: [22.32, 114.17] },
    { from: [22.32, 114.17], to: [35.68, 139.69] },
    { from: [35.68, 139.69], to: [1.35, 103.82] },
    { from: [33.74, -118.28], to: [51.51, -0.13] },
    { from: [51.51, -0.13], to: [25.27, 55.3] },
    { from: [25.27, 55.3], to: [13.08, 80.27] },
    { from: [22.32, 114.17], to: [37.57, 126.98] },
    { from: [51.51, -0.13], to: [50.94, 6.96] },
    { from: [1.35, 103.82], to: [31.23, 121.47] },
];
