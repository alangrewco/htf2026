    ...
    for (const s of mockShipmentListResponse.items) {
      await client.query(
        `INSERT INTO shipments (
          id, shipment_code, status, origin_port_id, destination_port_id, route_id, supplier_id, sku_ids_json, carrier, order_date, expected_delivery_date, eta, events_json, created_at, updated_at
