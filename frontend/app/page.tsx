...
export default function LandingPage() {
    const { containerRef: parallaxRef, targetRef: parallaxTargetRef } = useParallax(0.4);
            ...
            if (!ticked) {
                requestAnimationFrame(() => {
                    ...
                    if (ambientLightRef.current) {
                        ambientLightRef.current.style.transform = `translate(-50%, 0) translate(${x}px, ${y}px)`;
                    }
                    if (globeContainerRef.current) {
                        globeContainerRef.current.style.transform = `translate(${x * 0.3}px, ${y * 0.3}px)`;
                    }
                    ticked = false;
                });
                ticked = true;
        ...
        <div className="font-sans antialiased text-[#e4e0d8] bg-[#0c0c12] min-h-screen">
            ...
            <section className="relative min-h-screen flex items-center overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        ...
                        top: '10%', left: '50%', transform: `translate(-50%, 0) translate(0px, 0px)`,
                ...
                <div className="max-w-[1400px] mx-auto px-6 lg:px-12 w-full pt-24">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div
                            ...
                            style={{ transform: `translate(0px, 0px)`, transition: 'transform 0.4s ease-out' }}
                        >
                            <SupplyChainGlobe
                                size={560}
            ...
            <div ref={parallaxRef as React.RefObject<HTMLDivElement>} className="max-w-[1400px] mx-auto px-6 lg:px-12 py-20 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div ref={parallaxTargetRef as React.RefObject<HTMLDivElement>} className="lg:col-span-6 lg:col-start-7 space-y-10" style={{ transform: `translateY(0px)` }}>
