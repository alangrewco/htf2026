...
import { Truck, Users, MapPin, CheckCircle2, ShieldCheck, Navigation, Anchor, PackageCheck, FileText, ArrowLeft, ChevronRight } from "lucide-react";
                        ...
                        <div className="flex flex-col gap-2 text-center sm:text-left space-y-3 flex-1">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="min-w-0 flex-1">
                                    <h2 className="text-lg leading-none font-semibold">{shipment.shipment_code}</h2>
                                    <p className="mt-1">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <InfoRow icon={Users} label="Supplier" value={
                                        <span>{supplierName(shipment.supplier_id)}</span>
                                    } />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-1.5">
                                    {Object.entries(shipment.skus || {}).map(([skuId, qty]) => (
                                        <Badge key={skuId} variant="outline" className="bg-muted/30 text-[10px] font-mono cursor-pointer hover:bg-muted/50 transition-colors" onClick={() => router.push(`/skus/${skuId}`)}>
