        ...
        executionSteps: [
          {
            ...
            description:
              "Configuring Reuters alert feed for Port of Houston strike updates.",
            autonomousPreview:
              "✅ Alert configured — you'll receive daily updates via email and dashboard notification. Current status: Strike ongoing, no negotiations scheduled.",
          },
          {
            id: "es-1b",
            ...
            description:
              "Preparing email to notify downstream customers of potential delay.",
            draftContent: {
              to: "key-accounts@customers.com",
              subject:
                "[Important] Potential 3-week delay on LED shipments — Port of Houston strike",
        ...
        executionSteps: [
          {
            ...
            description:
              "Querying ElectroParts API for real-time LED module availability.",
            autonomousPreview:
              "✅ Inventory check complete — ElectroParts has 14 of 12 required SKUs in stock. Unit pricing confirmed at +18% premium ($45K total). Lead time: 2 days to ship.",
          },
          {
            id: "es-2b",
            type: "semi-autonomous",
            ...
            description:
              "Preparing the emergency PO for your review before sending.",
            draftContent: {
          ...
          },
          {
            ...
            description:
              "Booking expedited air freight from ElectroParts facility to Houston.",
            autonomousPreview:
              "✅ Air freight booked with FedEx Priority — Pickup scheduled for tomorrow 8AM EST from ElectroParts facility (Newark, NJ). Tracking: FX-8847291. ETA: 2 business days.",
          },
          {
            id: "es-2d",
            type: "autonomous",
            ...
            description:
              "Updating shipment tracking and inventory records in ERP.",
            autonomousPreview:
              "✅ ERP updated — New shipment SH-EM-001 created. Tracking linked. Inventory forecast adjusted for 12 SKUs. Warehouse team auto-notified via system alert.",
          },
          {
            id: "es-2e",
            type: "manual",
        ...
        executionSteps: [
          {
            ...
            description:
              "Checking vessel schedules and port availability for LA reroute.",
            autonomousPreview:
              "✅ Reroute analysis complete — Port of LA has capacity. Vessel MV Pacific Star can accept reroute with +5 day transit. Additional freight cost: $12,000. No other vessels available sooner.",
          },
          {
            id: "es-3b",
            type: "semi-autonomous",
            ...
            description:
              "Preparing email to GlobalTech logistics coordinator requesting shipment reroute.",
            draftContent: {
              to: "logistics@globaltech.com",
              subject:
                "Urgent: Reroute request for shipment SH-2048 to Port of Los Angeles",
          ...
          },
          {
            ...
            autonomousPreview:
              "✅ Inland transport booked — XPO Logistics truck scheduled for pickup at Port of LA on arrival day. Route: LA → Houston (2-day transit). Cost: $3,200. Tracking will be provided upon pickup.",
          },
        ],
      },
    ],
        ...
        executionSteps: [
          {
            id: "es-4a",
            type: "autonomous",
            label: "Check port loading schedule",
            description: "Querying Shenzhen port for available priority berths.",
            autonomousPreview:
              "✅ Priority berth available — Slot B-14 open tomorrow at 06:00 local. Expedite fee: $8,000. Must confirm within 4 hours.",
          },
          {
            id: "es-4b",
            type: "semi-autonomous",
            label: "Draft expedite request",
            description: "Preparing the expedite request form.",
            draftContent: {
              to: "portops@shenzhenport.gov.cn",
              subject: "Priority Loading Request — Shipment SH-3021",
              body: "Dear Port Operations,\n\nWe request priority loading for shipment SH-3021 at berth B-14 tomorrow at 06:00. We confirm acceptance of the $8,000 expedite fee.\n\nVessel: COSCO Pacific\nCargo: 8 microcontroller SKUs\n\nPlease confirm the slot reservation.\n\nRegards,\nSupply Chain Ops",
            },
          },
          {
            id: "es-4c",
            type: "manual",
            label: "Confirm departure with COSCO",
            description: "Call COSCO to confirm vessel loading.",
            manualInstruction:
        ...
        executionSteps: [
          {
            id: "es-5a",
            type: "autonomous",
            label: "Check TaiwanSemi inventory",
            description: "Querying TaiwanSemi for microcontroller availability.",
            autonomousPreview:
              "✅ All 8 SKUs available at TaiwanSemi. Lead time: 3 days production + 4 days air freight. Total: $22,000.",
          },
          {
            id: "es-5b",
            type: "semi-autonomous",
            label: "Draft purchase order",
            description: "Preparing PO for TaiwanSemi.",
            draftContent: {
              to: "sales@taiwansemi.com",
              subject: "Emergency PO — 8 Microcontroller SKUs",
              body: "Dear TaiwanSemi Sales,\n\nWe need to place an emergency order for 8 microcontroller SKUs due to Shenzhen port disruption.\n\nTotal: $22,000\nShipping: Air freight to Long Beach, CA\nRequired delivery: Within 7 days\n\nPlease confirm and send PO acknowledgment.\n\nRegards,\nProcurement",
            },
          },
          {
            id: "es-5c",
            type: "autonomous",
            label: "Update supply chain records",
            description: "Updating sourcing records and insurance documentation.",
            autonomousPreview:
              "✅ Records updated — New sourcing entry for TaiwanSemi added. Insurance claim initiated for Shenzhen shipment delay (Claim #INS-2026-0847).",
          },
        ],
      },
    ],
        ...
        executionSteps: [
          {
            id: "es-6a",
            type: "autonomous",
            label: "Identify domestic suppliers",
            description: "Searching supplier database for qualified US steel suppliers.",
            autonomousPreview:
              "✅ Found 3 qualified suppliers: USMetals Corp (low risk), SteelCo Inc (low risk), AmeriSteel LLC (medium risk). Requesting quotes from all three.",
          },
          {
            id: "es-6b",
            type: "semi-autonomous",
            label: "Draft RFQ to suppliers",
            description: "Preparing request for quote.",
            draftContent: {
              to: "sales@usmetals.com; quotes@steelco.com",
              subject: "RFQ — Steel Components for 5 SKUs (Tariff Mitigation)",
        ...
        executionSteps: [
          {
            id: "es-7a",
            type: "autonomous",
            label: "Generate cost impact analysis",
            description: "Calculating tariff impact across product lines.",
            autonomousPreview:
              "✅ Analysis complete — 5 product lines affected. Average cost increase: 10.2%. Recommended price adjustment: 8-12% depending on product margin.",
          },
          {
            id: "es-7b",
            type: "semi-autonomous",
            label: "Draft pricing proposals",
            description: "Preparing pricing adjustment letters.",
            draftContent: {
              to: "key-accounts@customers.com",
              subject:
                "Pricing Adjustment Notice — EU Carbon Border Tax Impact",
          ...
          },
          {
            id: "es-7c",
            type: "manual",
            label: "Schedule customer calls",
            description: "Set up calls with key accounts.",
            manualInstruction:
              "Please schedule calls with your top 5 customers to discuss the pricing adjustments. Use the cost impact analysis and pricing proposals as talking points. Key accounts to contact:\n\n1. Acme Corp — John Smith\n2. TechParts Inc — Sarah Lee\n3. BuildRight — Mike Johnson\n4. GlobalAssembly — Wei Zhang\n5. QuickShip Corp — Ana Martinez\n\nConfirm once calls are scheduled.",
          },
        ],
      },
    ],
        ...
        executionSteps: [
          {
            id: "es-9a",
            type: "autonomous",
            label: "Verify reorder details",
            description:
              "Cross-checking automated reorder against inventory policy.",
            autonomousPreview:
              "✅ Reorder verified — SKU-456 order matches safety stock policy. Pricing within 5% of contract rate. ElectroParts confirmed shipment.",
          },
          {
            id: "es-9b",
            type: "autonomous",
            label: "Log audit trail",
            description: "Recording action in supply chain audit system.",
            autonomousPreview:
              "✅ Audit logged — Entry #AUD-2026-1847 created. Automated reorder approved and documented.",
          },
        ],
      },
    ],
        ...
        executionSteps: [
          {
            id: "es-10a",
            type: "autonomous",
            label: "Review forecast model",
            description: "Analyzing demand forecast accuracy and assumptions.",
            autonomousPreview:
              "✅ Forecast review complete — Model accuracy: 94% over last 4 quarters. Q2 spike prediction based on 3-year historical pattern. Confidence: High.",
          },
          {
            id: "es-10b",
            type: "autonomous",
            label: "Confirm WMS levels",
            description:
              "Verifying buffer stock levels in warehouse management system.",
            autonomousPreview:
              "✅ WMS confirmed — All 6 SKUs buffer levels updated. Total additional holding: $45,000. Space allocation: Verified with warehouse capacity.",
          },
          {
            id: "es-10c",
            type: "manual",
            label: "Approve holding cost",
            description: "Finance approval needed.",
            manualInstruction:
              "Please approve the $45,000 additional holding cost allocation with your finance department. This needs budget code approval and sign-off from the CFO for amounts over $25K.\n\nConfirm once finance has approved the allocation.",
          },
        ],
      },
      {
        ...
        executionSteps: [
          {
            id: "es-11a",
            type: "autonomous",
            label: "Cancel restock orders",
            description: "Cancelling pending orders for 6 SKUs.",
            autonomousPreview:
              "✅ 4 of 6 pending orders cancelled. 2 orders already shipped — these will be received but not trigger additional reorders.",
          },
          {
            id: "es-11b",
            type: "autonomous",
            label: "Reset safety stock",
            description: "Reverting thresholds in WMS.",
            autonomousPreview:
              "✅ Safety stock thresholds reset to pre-adjustment levels for all 6 SKUs. Stockout risk: 18% for Q2. Operations team notified via system alert.",
          },
        ],
      },
    ],
...
const getActionCards = async (): Promise<ActionCard[]> => mockActionCards;

export const useActionCards = () => {
  return useSwr(["mock", "action-cards"], getActionCards, {
