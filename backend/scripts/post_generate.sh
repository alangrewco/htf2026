...
MAIN_TEMPLATE="$ROOT_DIR/app/templates/generated_main.py"
MAIN_TARGET="$GEN_DIR/openapi_server/__main__.py"
DOCKER_TEMPLATE="$ROOT_DIR/app/templates/generated_Dockerfile"
DOCKER_TARGET="$GEN_DIR/Dockerfile"
...
cp "$DOCKER_TEMPLATE" "$DOCKER_TARGET"
